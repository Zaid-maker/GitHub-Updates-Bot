...
export default class Actions {
            ...
            db.collection("subscriptions").insertOne(
              ...
              (err, result) => {
                ...
                let embed1 = new MessageEmbed()
                  ...
                  .setTimestamp()
                  .setFooter(
                    "© 2021 - 2022 Mapleshade",
                    "https://cdn.discordapp.com/attachments/653733403841134600/916607168734691328/Mapleshade.NO-7.png"
                  );
  ...
  static help(channel) {
    let embed3 = new MessageEmbed()
      ...
      .addField(
        "Add",
        `add <repo> - Subscribe to a Repo in the Current Channel`,
        true
      )
      .addField(
        "Remove",
        `remove <repo> - Remove a subscription from the Current Channel`,
        true
      )
      .setTimestamp()
      .setFooter(
